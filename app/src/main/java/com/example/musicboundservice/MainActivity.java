...
public class MainActivity extends AppCompatActivity {
 ...
 //   private RecyclerView recyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listMusic.add(new Music("Có chắc yêu là đây", R.raw.cochacyeulady, R.drawable.cochacyeuladay));
        listMusic.add(new Music("Thiên Đàng", R.raw.thiendang, R.drawable.thiendang));
        listMusic.add(new Music("Big City Boy", R.raw.bigcity, R.drawable.bigcity));
        listMusic.add(new Music("Trên tình bạn dưới tình yêu", R.raw.trentinhbanduoitinhyeu, R.drawable.trentinhban));
